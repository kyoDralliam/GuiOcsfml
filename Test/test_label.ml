...
let _ = 
  ...
  let button_tex = new OcsfmlGraphics.texture (`File "gui2.png") in
...
*)
    let normal = Texture3x3.create_from_subrect
      ...
      IntRect.({ left = 201 ; top = 114 ; width = 165 ; height = 48}) button_tex 
    in
    let hovered = Texture3x3.create_from_subrect
      ~left_border:25 ~right_border:25 ~bottom_border:14 ~top_border:14 
      IntRect.({ left = 201 ; top = 178 ; width = 165 ; height = 48}) button_tex 
    in
    let clicked = Texture3x3.create_from_subrect
      ~left_border:25 ~right_border:25 ~bottom_border:14 ~top_border:14 
      IntRect.({ left = 201 ; top = 242 ; width = 165 ; height = 48}) button_tex 
    in
  ...
  left_layout#add (Widget.empty_widget) 30.  ;
  ...
  right_layout#add (Widget.empty_widget) 30.  ;
  right_layout#add button4            5. ;
  right_layout#add (Widget.empty_widget) 9.5  ;
